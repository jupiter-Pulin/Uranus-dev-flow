...
const commandPath = resolve(root, 'commands/deep-explore.md');
...
test('commands/deep-explore.md has --agents and --waves', () => {
  const content = readFileSync(commandPath, 'utf8');
  assert.match(content, /--agents/, 'should have --agents argument');
  assert.match(content, /--waves/, 'should have --waves argument');
});
