...
<!-- BEGIN:HERO-COUNT -->
98 bundled · 96 public skills · 15 agents — Claude の context window のわずか ~4%
<!-- END:HERO-COUNT -->
...
| 方法 | 対応ツール | カバー範囲 |
|------|-----------|-----------|
| プラグインインストール | Claude Code | フル（98 bundled skills、フック、ルール、auto-loop） |
...
| カテゴリ | 数 | 例 |
|----------|-----|-----|
| スキル | 96 public (98 bundled) | `/project-setup`, `/codex-review-fast`, `/verify`, `/smart-commit`, `/deep-research` |
